...
//
//        RequestReceiver requestReceiverFlight = new RequestReceiver(new ResourceManagerImpl(), 8087);
//        try {
...
//        }
//
//        RequestReceiver requestReceiverHotel = new RequestReceiver(new ResourceManagerImpl(), 8088);
//        try {
...
//        }
//
//        RequestReceiver requestReceiverCar = new RequestReceiver(new ResourceManagerImpl(), 8089);
//        try {
...
//        }
//
//        RequestReceiver requestReceiverCustomer = new RequestReceiver(new ResourceManagerImpl(), 8090);
//        try {
